...
public class BinarySearch {
    ...
    public static void main(String[] args) {
      StdOut.println("can anything printed out?");

        // read the integers from a file, tinyW.txt
        In in = new In(args[0]);
        ...
        // read integer key from standard input, tinyT.txt ; print if not in whitelist(tinyW.txt)
        while (!StdIn.isEmpty()) {
            int key = StdIn.readInt();
            StdOut.println("all keys: " + key);
